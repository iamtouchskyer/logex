...
const en = {
  ...
  'landing.subtitle': 'Logex turns coding-agent transcripts (Claude Code, Codex) into blog-quality articles — automatically. Your sessions, your insights, your narrative.',
...
const zh: Record<DictKey, string> = {
  ...
  'landing.subtitle': 'Logex 把 coding agent（Claude Code、Codex）的对话转成博客级别的文章——全自动。你的 session，你的洞察，你的叙事。',
  'landing.stat.tokensNumber': '780M+',
