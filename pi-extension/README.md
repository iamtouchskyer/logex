...
- **Command `/logex [path.jsonl]`** — resolves the newest Pi session (or takes an explicit Claude Code / Codex / Pi / DSH JSONL path) and sends the workflow prompt into the conversation, triggering a turn.
